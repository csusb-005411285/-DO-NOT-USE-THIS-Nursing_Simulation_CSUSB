...
public static class CharacterConfig
{
    ...
    public readonly static CharacterSettings bob = new CharacterSettings(0, "bob", Amazon.Polly.VoiceId.Matthew);
    /// character 1: "sally" (arbitrary name), Female
    public readonly static CharacterSettings sally = new CharacterSettings(1, "sally", Amazon.Polly.VoiceId.Amy);
    ...
    public readonly static CharacterSettings[] characterList = {bob, sally};
}

/// class for holding all setings for a character instance
public class CharacterSettings
{
    /// character number, should mirror location in characterList[]
